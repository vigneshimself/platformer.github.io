...
class GameScene extends Phaser.Scene {
  ...
  preload() {
    this.load.image('cave', 'https://i.ibb.co/rdNMtYP/cave-background.png');
    this.load.image('platform', 'https://i.ibb.co/Qm3nHKx/platform.png');
    this.load.spritesheet('codey', 'https://i.ibb.co/vzW2Frm/codey-sprite.png', { frameWidth: 72, frameHeight: 90 });
    this.load.spritesheet('snowman', 'https://i.ibb.co/rbjzrKt/snowman.png', { frameWidth: 50, frameHeight: 70 });
    this.load.spritesheet('exit', 'https://i.ibb.co/0rkhwd3/cave-exit.png', { frameWidth: 60, frameHeight: 70 });
  }
